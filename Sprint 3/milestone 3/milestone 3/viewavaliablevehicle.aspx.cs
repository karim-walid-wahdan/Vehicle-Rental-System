...
{
    public partial class avaliablevehicle : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("viewVehicles", conn);
            ...
            while (rdr.Read())
            {
                ...
                object temp2 = rdr.GetValue(rdr.GetOrdinal("loc"));
                string loc = temp2.ToString();
                object temp = rdr.GetValue(rdr.GetOrdinal("average rating"));
                avgrate = temp.ToString();
                ...
                if (avgrate != "")
                {
                    ...
                    lbl_avg.Text = "average rating:" + avgrate + "<br/>";
                    div1.Controls.Add(lbl_avg);
                }
                else{
        ...
        protected void brand_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("orderVehiclesByBrand", conn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void class_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("orderVehiclesByClass", conn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        protected void price_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("orderVehiclesByRate", conn);
            cmd.CommandType = CommandType.StoredProcedure;
