<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerRegisteration.aspx.cs" Inherits="milestone_3.customerRegisteration" %>
          ...
          <h1 style ="background-color:#7395AE;color:white;"><label style="position:relative ;left:600px">welcome to hackers rentals</label></h1>
            ...
            <p> Welcome to our family please enter the required data below for ur registeration as one of our customers</p> 
             ...
             <div style="position:relative ;left:650px">
                  ...
                  <br />
                  <asp:Button ID="joinus"  BackColor="#7395AE" BorderStyle="None" runat="server" Text="join us" OnClick="joinus_Click" style="height: 25px" />
